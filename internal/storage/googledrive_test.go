...
func TestGoogleDriveAdapter_ResolveRemotePath(t *testing.T) {
	...
	tests := []struct {
		...
		{"", "/my-hippodrop-root"},
		{"/", "/my-hippodrop-root"},
		{"file.txt", "/my-hippodrop-root/file.txt"},
		{"/file.txt", "/my-hippodrop-root/file.txt"},
		{"folder/file.txt", "/my-hippodrop-root/folder/file.txt"},
		{"/folder/file.txt", "/my-hippodrop-root/folder/file.txt"},
		{"../outside.txt", "/my-hippodrop-root/outside.txt"}, // filepath.Clean/Join prevents escaping root
		{"folder/sub/../../file.txt", "/my-hippodrop-root/file.txt"},
	}
