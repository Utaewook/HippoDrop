...
3. You will see "Google Drive API". Click the blue **[Enable]** button.
   *(If it asks you to create a project first, click "Create Project", name it "tardis-storage", and click "Create". Then click [Enable] again).*
...
3. **App information**: Type "Tardis" for the App name, and select your email from the dropdown for the support email.
...
4. Name it anything (e.g., "Tardis Client") and click **[Create]**.
...
3. Complete the wizard. Tardis will give you a link to open in your browser to log in securely!
